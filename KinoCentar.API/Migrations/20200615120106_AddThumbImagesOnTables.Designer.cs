...
namespace KinoCentar.API.Migrations
{
    ...
    [Migration("20200615120106_AddThumbImagesOnTables")]
    partial class AddThumbImagesOnTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KinoCentar.API.EntityModels.ProjekcijaRaspored", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProjekcijaRaspored");
                });

            modelBuilder.Entity("KinoCentar.API.EntityModels.ProjekcijaRasporedVrijeme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ProjekcijaRasporedId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProjekcijaRasporedId");

                    b.ToTable("ProjekcijaRasporedVrijeme");
                });
            ...
            modelBuilder.Entity("KinoCentar.API.EntityModels.Rezervacija", b =>
                {
                    ...
                    b.Property<int>("ProjekcijaRasporedVrijemeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProjekcijaRasporedVrijemeId");
            ...
            modelBuilder.Entity("KinoCentar.API.EntityModels.ProjekcijaRasporedVrijeme", b =>
                {
                    b.HasOne("KinoCentar.API.EntityModels.ProjekcijaRaspored", "ProjekcijaRaspored")
                        .WithMany("Vremena")
                        .HasForeignKey("ProjekcijaRasporedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("KinoCentar.API.EntityModels.Rezervacija", b =>
                {
                    ...
                    b.HasOne("KinoCentar.API.EntityModels.ProjekcijaRasporedVrijeme", "ProjekcijaRasporedVrijeme")
                        .WithMany("Rezervacije")
                        .HasForeignKey("ProjekcijaRasporedVrijemeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
